...
variable "instance_class" {
  description = "The instance type of the RDS MSSQL instance"
  type        = string
}
variable "username" {
  description = "The master username for the RDS MSSQL instance"
  type        = string
}
variable "license_model" {
  description = "The license model for the RDS MSSQL instance (license-included)"
  type        = string
  default     = "license-included"
}
variable "backup_retention" {
  description = "The days to retain backups for the RDS MSSQL instance"
  type        = number
  default     = 7
}
variable "allocated_storage" {
  description = "The allocated storage in gigabytes for the RDS MSSQL instance"
  type        = number
  default     = 20
}
