...
# =====================================================================
# RDS Instance - MySQL Database Target
# =====================================================================
resource "aws_db_instance" "mysql" {
  identifier              = "${lower(var.alias)}-mysql"
  engine                  = "mysql"
  ...
  vpc_security_group_ids  = [data.terraform_remote_state.aws_security.outputs.mysql_target_sg_id]
  ...
  tags = {
    Name                 = "${lower(var.alias)}-mysql"
    Project              = var.alias
    I_Owner              = var.asset_owner_name
    I_Purpose            = "${var.alias} Lab MySQL Target"
